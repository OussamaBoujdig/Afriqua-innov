...
export default function ValidationDetailleePage() {
  return (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800/60 shadow-sm hover:shadow-md transition-all duration-300 p-4">
            ...
            <div className="space-y-4">
              <div className="flex flex-col items-start">
                <div className="flex justify-between items-start w-full text-xs mb-1">
                  <div>
                    <span className="font-semibold text-slate-700 dark:text-slate-300">Innovation</span>
                    <p className="text-[9px] font-medium text-slate-500 normal-case mt-0.5">Nouveauté par rapport aux solutions existantes.</p>
                  </div>
                  <span className="font-bold text-primary">8/10</span>
                </div>
              ...
              <div className="flex flex-col items-start">
                <div className="flex justify-between items-start w-full text-xs mb-1">
                  <div>
                    <span className="font-semibold text-slate-700 dark:text-slate-300">Faisabilité</span>
                    <p className="text-[9px] font-medium text-slate-500 normal-case mt-0.5">Complexité de mise en œuvre et stack technique.</p>
                  </div>
              ...
              <div className="flex flex-col items-start">
                <div className="flex justify-between items-start w-full text-xs mb-1">
                  <div>
                    <span className="font-semibold text-slate-700 dark:text-slate-300">Alignement</span>
                    <p className="text-[9px] font-medium text-slate-500 normal-case mt-0.5">Adhésion aux objectifs définis pour 2026.</p>
                  </div>
              ...
              <div className="flex flex-col items-start">
                <div className="flex justify-between items-start w-full text-xs mb-1">
                  <div>
                    ...
                    <p className="text-[9px] font-medium text-slate-500 normal-case mt-0.5">Impact financier estimé sur une période de 3 ans.</p>
                  </div>
              ...
              <div className="flex flex-col items-start">
                <div className="flex justify-between items-start w-full text-xs mb-1">
                  <div>
                    <span className="font-semibold text-slate-700 dark:text-slate-300">Risque</span>
                    <p className="text-[9px] font-medium text-slate-500 normal-case mt-0.5">Risques techniques, marché et opérationnels.</p>
                  </div>
                  <span className="font-bold text-primary">4/10</span>
                </div>
